...
const partTwoTestInput = `eyr:1972 cid:100
...
describe('Day 4', () => {
  describe('Part One', () => {
    it('should return 2 given test input', () => {
      assert.strictEqual(partOne(testInput), 2)
    });
  });
  
  describe('Part Two', () => {
    it('should return 4 given new test input', () => {
      assert.strictEqual(partTwo(partTwoTestInput), 4)
    });
  });
